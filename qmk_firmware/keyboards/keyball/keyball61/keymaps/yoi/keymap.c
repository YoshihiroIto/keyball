...
const int16_t to_clickable_movement = 25; // クリックレイヤーが有効になるしきい値
...
const key_override_t up_key_override = ko_make_basic(MOD_MASK_CTRL, KC_P, KC_UP);
